...
base.py
───────
Contrato Strategy para una familia de algoritmo: cómo se construye, entrena,
predice y evalúa, sin que el resto del stack conozca la clase concreta de sklearn.
"""
...
class ModelStrategy(ABC):
    ...
    def cv_score(self, model, X, y, cv: int, scoring: str) -> np.ndarray:
